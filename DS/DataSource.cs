    ...
    public static class DataSource
    {
        ...
        static void InitAllLists()
        {
            ...
            ListUsers = new List<User>
            {
                ...
                new User{UserName = "sara", Password = "1111", Email="saramalka2003@gmail.com", AuthorizationManagement = AuthorizationManagement.Manager, FirstName="שרה מלכה", LastName = "חמו", Address="כוכב השחר מול נבו", PhoneNumber="0544325928"},
